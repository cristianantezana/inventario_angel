                                          ...
                                          <tbody id="data_persona">
                                             ...
                                             <tr>
                                                ...
                                                <td class="text-center">
                                                   <button type="button" "  class="btn btn-warning" data-toggle="modal" data-target="#editarPersona{{$item->cod_producto}}"><i class="fa fa-pencil" aria-hidden="true">  </i>
                                                    </button>
                                                <td><center>
