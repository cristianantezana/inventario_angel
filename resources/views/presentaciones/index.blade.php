                                          ...
                                          <tbody id="data_persona">
                                             ...
                                             <tr>
                                                ...
                                                <td class="text-center">
                                                   <button type="button" "  class="btn btn-warning" data-toggle="modal" data-target="#editarPresentacion{{$item->cod_presentacion}}"><i class="fa fa-pencil" aria-hidden="true">  </i>
                                                    </button>
                                                <td><center>
                                                   <button class="btn btn-danger eliminarPresentacion" 
                                                   action="{{ url('presentaciones/destroy',$item->cod_presentacion) }}" method="DELETE" token="{{ csrf_token() }}" pagina="presentaciones/index">
